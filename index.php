...
<body>
    <section class="header">
            ...
            <div class="nav-links" id="navlinks">
                ...
                <ul>
                    ...
                    <li><a href="">LOGIN-AS</a>
                        <ul>
                            <li><a href="Admin/ohcms_admin_login.php">ADMIN</a></li>
                            <li><a href="DepartmentHead/dept_head_login.php">DEPARTMENTHEAD</a></li>
                            <li><a href="RegistrationDesk/employee_login.php">EMPLOYEE</a></li>
                            <li><a href="Pharmacy/employee_login.php">PHARMECY</a></li>
                            <li><a href="Laboratory/employee_login.php">LABORATORY</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
        ...
        <div class="text-box">
            <h1>Health care managment</h1>
            <p>
                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Adipisci illum esse dolor. <br> Incidunt
                facere labore enim voluptas aliquid
            </p>
            <a href="https://cyborgsapient.com/" class="btn-a"> vist our site</a>
        </div>
