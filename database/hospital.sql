...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 03, 2022 at 12:59 PM
...
(15, 'bishnu', 'chaudhary', 'admin@ohcms.com', 'bishnu@gmail.com', 'd033e22ae348aeb5660fc2140aec35850c4da997', 'brgj', '9999999999', 'Registration Desk', '', '', '', '', '', '', '', '', '');
...
(8, 'admin@ohcms.com', 'Approved', '2022-11-03 11:20:19.90037'),
(9, 'employee@ohcms.com', 'Approved', '2022-11-02 19:00:03.51191');
...
(8, 'bishnu', 'chaudhary', '23', 'brgj', '', '', '', '', '', 'OutPatient', '', '2022-11-27', '', '', '', '', '', '', '', ''),
(9, 'bishnu', 'chaudhary', '23', 'brgj', '', '', '', '', '', 'InPatient', '', '2022-11-01', '', '', '', '', '', '', '', ''),
(10, 'bishnu', 'chaudhary', '23', 'brgj', '', '<p>fiver</p>', '', '', '<p>perasitamol</p>', 'Isolation Patient', '', '2022-11-01', '', '', '', '', '', '', '', '');
...
(3, 'perasitamol', 'Anti Biotics', '<p>use for fiver</p>', '5', 'hospital', '2022-11-04', '2022-11-24');
...
--
ALTER TABLE `hospital_employees`
  MODIFY `em_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `pharmaceuticals`
  MODIFY `pharm_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
