                ...
                <form method="POST">
                  <div class="form-group row">
                    ...
                    <div class="col-12 col-sm-8 col-lg-6">
                      <input class="form-control" required id="inputText3" name="dept_name" type="text" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Department Head</label>
                    <div class="col-12 col-sm-8 col-lg-6">
                      <input class="form-control" required id="inputText3" name="dept_head" type="text" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Department Head Email Adddress</label>
                    <div class="col-12 col-sm-8 col-lg-6">
                      <input class="form-control" required id="inputText3" name="dept_head_email" type="text" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Department Head Password</label>
                    <div class="col-12 col-sm-8 col-lg-6">
                      <input class="form-control" id="inputText3" name="dept_head_password" type="password" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Department Description</label>
                    <div class="col-12 col-sm-8 col-lg-6">
                      <textarea class="form-control" id="editor" name="dept_desc" type="text" required></textarea>
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <p class="text-right">
