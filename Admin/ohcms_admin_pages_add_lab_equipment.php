                ...
                <form method="POST">
                  <div class="form-group row">
                    ...
                    <div class="col-12 col-sm-8 col-lg-6">
                      <input class="form-control" id="inputText3" name="name" type="text" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Equipment Description</label>
                    <div class="col-12 col-sm-8 col-lg-6">
                      <textarea class="form-control" id="editor" name="description" type="text" required>
                      </textarea>
                    </div>
                  </div>
                  <div class="form-group row" style="display:none">
                    ...
                    <div class="col-12 col-sm-8 col-lg-6">
                      <input class="form-control" id="inputText3" name="department" value="Laboratory" readonly type="text" required>
                    </div>
                  </div>

                  <div class="form-group row">
                    <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Equipment Status</label>
                    <select class=" form control col-12 col-sm-8 col-lg-6" name="status" required>
