...
<head>
  ...
  <link rel="shortcut icon" href="assets/img/S_logo.png">
  <title>Cyborgspient Hospital Management System</title>
...
body{
  background:url('assets/img/img3.webp')
}
span {
    font-size: 129%;
    color: #e4b1b1;
      ...
      <div class="main-content container-fluid">
        <div class="splash-container">
          <div class="card card-border-color card-border-color-primary">
            <div class="card-header"><img class="logo-img" src="assets/img/d_logo.png" alt="logo" width="102" height="27"><span class="splash-description">Patient Registration Department Login Panel</span></div>
            <div class="card-body">
          ...
          <div class="splash-footer"><span>© Cyborgspient Hospital Management System</span></div>
          <div class="splash-footer"><span>Powered By <a href="https://cyborgsapient.com">Cyborgspient</a></span></div>
          <div
           class="splash-footer"><span><a href="../">Home</a></span>
          </div>
        </div>
      </div>
    </div>
