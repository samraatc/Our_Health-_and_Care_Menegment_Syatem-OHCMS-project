                ...
                <form method="POST">
                  <div class="form-group row">
                    ...
                    <div class="col-12 col-sm-8 col-lg-6">
                      <input class="form-control" id="inputText3" name="p_name" type="text" required>
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-12 col-sm-8 col-lg-6">
                      <input class="form-control" id="inputText3" name="p_mobile" type="text" required>
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-12 col-sm-8 col-lg-6">
                      <textarea class="form-control" id="inputText3" name="p_consultancy" type="text" required></textarea>
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <p class="text-right">
