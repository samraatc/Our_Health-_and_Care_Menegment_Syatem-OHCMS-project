      ...
      <div class="main-content container-fluid">
        <div class="splash-container">
          <div class="card card-border-color card-border-color-primary">
            <div class="card-header"><img class="logo-img" src="assets/img/d_logo.png" alt="logo" width="102" height="27"><span class="splash-description">Pharmacy Department Login Panel</span></div>
            <div class="card-body">
